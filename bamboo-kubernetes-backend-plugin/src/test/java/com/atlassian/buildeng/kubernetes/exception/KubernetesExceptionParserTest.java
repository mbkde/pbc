...
public class KubernetesExceptionParserTest {
    ...
    public void testPodLimitQuotaException() {
        ...
        assert mapper.map("kubectl returned non-zero exit code.", shellException) instanceof PodLimitQuotaExceededException;
    }
    ...
    public void testConcurrentResourceQuotaModificationException() {
        ...
        assert mapper.map("kubectl returned non-zero exit code.", shellException) instanceof ConcurrentResourceQuotaModificationException;
    }
