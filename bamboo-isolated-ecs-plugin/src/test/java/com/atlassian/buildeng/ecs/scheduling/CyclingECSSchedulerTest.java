...
public class CyclingECSSchedulerTest {
    ...
    public void scheduleScaleUp() throws Exception {
        ...
        try {
            scheduler.schedule(new SchedulingRequest("cluster", "asg", 1l, "a1", 1, 600, 100));
    ...
    public void scheduleNoScaling() throws Exception {
        ...
        CyclingECSScheduler scheduler = new CyclingECSScheduler(schedulerBackend);
        String arn = scheduler.schedule(new SchedulingRequest("cluster", "asg", 1l, "a1", 1, 110, 110)).getContainerArn();
        scheduler.shutdownExecutor();
        scheduler.executor.awaitTermination(200, TimeUnit.MILLISECONDS); //make sure the background thread finishes
    ...
    public void scheduleTerminateStale() throws Exception {
        ...
        CyclingECSScheduler scheduler = new CyclingECSScheduler(schedulerBackend);
        String arn = scheduler.schedule(new SchedulingRequest("cluster", "asg", 1l, "a1", 1, 100, 100)).getContainerArn();
        scheduler.shutdownExecutor();
        scheduler.executor.awaitTermination(200, TimeUnit.MILLISECONDS); //make sure the background thread finishes
    ...
    public void scheduleUnusedFreshIsSelected() throws Exception {
        ...
        CyclingECSScheduler scheduler = new CyclingECSScheduler(schedulerBackend);
        String arn = scheduler.schedule(new SchedulingRequest("cluster", "asg", 1l, "a1", 1, 600, 600)).getContainerArn();
        scheduler.shutdownExecutor();
        scheduler.executor.awaitTermination(200, TimeUnit.MILLISECONDS); //make sure the background thread finishes
    ...
    public void scheduleRequestCoalesce() throws Exception {
        ...
        CyclingECSScheduler scheduler = new CyclingECSScheduler(schedulerBackend);
        Future<SchedulingResult> res = scheduler.scheduleImpl(new SchedulingRequest("cluster", "asg", 1l, "a1", 1, 199, 399));
        Future<SchedulingResult> res2 = scheduler.scheduleImpl(new SchedulingRequest("cluster", "asg", 2l, "a2", 1, 599, 599));
