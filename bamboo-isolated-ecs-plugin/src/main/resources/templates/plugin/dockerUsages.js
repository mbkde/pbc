...
AJS.$(document).ready(function () {
    ...
    var revision = paramByName('revision', window.location.search);
    if (image === null || revision === null) {
        //TODO show text field to enter image name
        AJS.$("#dockerImageDiv").append("<p>Missing ?image or ?revision query in url.</p>");
    } else {
